...
class Commander(urwid.Frame):
    ...
    on bottom line and display frame above
...
You can also asynchronously output
messages with Commander.output('message') """
    ...
    def __init__(self, title, game, command_caption='Command:  (Tab to switch focus to upper frame, where you can scroll text)', cmd_cb=None, max_size=1000):
        self.game = game
    ...
    def on_line_entered(self, line):
        """ what do do when a line is entered """
        self.game.input_text(line)
...
if __name__=='__main__':
    ...
    c=Commander('ADVENTURE THE GAME')
    #start main loop
    c.loop()
